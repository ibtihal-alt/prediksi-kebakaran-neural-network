  ...
  <div class="container">
    <div class="row justify-content-center my-4">
      <div class="col-md-8 px-0">
        <h3 class="m-0 fw-bold text-secondary">TAMBAHKAN DATA ASLI</h3>
      </div>
            ...
            <div class="incidentBox d-flex gap-3 my-4 p-3 rounded">
              <div class="form-check">
                ...
                <label class="form-check-label" for="no-fire">
                  <h4 class="fw-bold m-0 text-success"><i class="fab fa-envira"></i> AMAN </h4>
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" value="1" name="incident" id="fire">
                <label class="form-check-label" for="fire">
                  <h4 class="fw-bold m-0 text-danger"><i class="fas fa-fire-alt"></i> KEBAKARAN! </h4>
                </label>
              </div>
            </div>
          </div>
